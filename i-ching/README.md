...
Reference: https://www.unicode.org/charts/nameslist/n_4DC0.html

Hexagrams are formed by a selection of a bottom trigram and a top trigram

The key sequence to generate a hexagram is to press the i-ching activation layer key, then a number between 0 and 7 in the Keypad followed by a number from the alpha-numeric keyboard.
